...
const ChatLayout = ({ isChatOpen, toggleChat }) => {
  return isChatOpen ? (
    <div className="fixed inset-y-5 bottom-20 right-5 bg-white w-80 shadow-lg rounded-lg p-4 flex flex-col">
      ...
      <div className="flex justify-around p-4 border-t">
        <Link to="chat-home" className="flex flex-col items-center">
          <svg
            className="w-6 h-6"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <Link to="help" className="flex flex-col items-center">
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M9 12h6m2 4h2M3 16h2m4 4h8m4-4a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"
            />
          </svg>
